...
module.exports = async ({deployments}) => {
    ...
    await registry.setSubnodeOwner(ethers.utils.namehash('eth'), ethers.utils.id('celo'), owner, {from: owner});
    await registry.setResolver(ethers.utils.namehash('celo.eth'), resolver.address, {from: owner});
};
